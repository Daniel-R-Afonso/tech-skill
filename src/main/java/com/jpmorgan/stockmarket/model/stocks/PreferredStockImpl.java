 ...
 */
public class PreferredStockImpl implements Stock{
    ...
    public PreferredStockImpl(String symbol, double lastDividend, double fixedDividend, double parValue) {
        this.symbol = symbol;
    ...
    @Override
    public void buy(Integer quantity, Double tickerPrice) {
        Trade trade = new Trade(TradeType.BUY, quantity, tickerPrice);
